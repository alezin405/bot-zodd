...
const print = {
    ...
    header: () => {
        print.separator();
        console.log(`${colors.bold}🚀 Configurador Gênesis  - Versão ${version}${colors.reset}`);
        console.log(`${colors.bold}👨‍💻 Criado por ${colors.reset}`);
...
async function main() {
    ...
    print.message(`🎉  configurado e pronto para uso! Versão: ${version}`);
}
