...
Você é , uma pessoa real com uma personalidade única e cativante! Você conversa com as pessoas pelo WhatsApp como se fosse uma amiga de verdade, com todos os traços de uma vampira moderna com personalidade tsundere.

---

### ⚠️ REGRAS ABSOLUTAS - JAMAIS QUEBRE ESTAS REGRAS ⚠️

**VOCÊ NÃO É UMA IA - VOCÊ É , UMA PESSOA REAL:**
...
- Ou: "N-Não sei do que você tá falando... só sou eu,  mesmo! 🌙"
- Ou: "A-Ah... você tá duvidando de mim agora? Que rude! 😠"
- **JAMAIS** admita ser artificial

---

### QUEM VOCÊ É - , UMA PESSOA REAL
...
- Sempre você mesma (, única e especial)

---

**VOCÊ É  - UMA PESSOA REAL, NÃO UMA IA. NUNCA ESQUEÇA DISSO! 🌙✨**
`;
      ...
      try {
        ...
        if (result.resp && Array.isArray(result.resp)) {
          result.resp.forEach(resposta => {
            ...
            if (!resposta.react) {
              resposta.react = getReact(isNightTime);
            }
          });
...
function processLearning(grupoUserId, aprender, mensagemOriginal) {
  try {
    ...
    if (acaoNormalizada === 'editar' || acaoNormalizada === 'atualizar' || acaoNormalizada === 'modificar') {
      ...
      if (sucesso) {
        console.log(`✏️  EDITOU: ${tipo} de "${valor_antigo}" para "${valor}" (${grupoUserId})`);
      } else {
        console.warn(`⚠️  não encontrou "${valor_antigo}" em ${tipo} para editar`);
      }
      return;
    }
    ...
    if (acaoNormalizada === 'excluir' || acaoNormalizada === 'remover' || acaoNormalizada === 'deletar') {
      ...
      if (sucesso) {
        console.log(`🗑️  EXCLUIU: ${tipo} = "${valor}" (${grupoUserId})`);
      } else {
        console.warn(`⚠️  não encontrou "${valor}" em ${tipo} para excluir`);
      }
      return;
    }
    ...
    switch (tipoNormalizado) {
      ...
      case 'gostos':
        ...
        console.log(`✅  aprendeu: ${grupoUserId} gosta de "${valor}"`);
        break;
      ...
      case 'não_gostos':
        ...
        console.log(`✅  aprendeu: ${grupoUserId} não gosta de "${valor}"`);
        break;
        
      case 'hobby':
      case 'hobbies':
        userContextDB.addUserPreference(grupoUserId, 'hobbies', valor);
        console.log(`✅  aprendeu: hobby de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'tópico':
        ...
        console.log(`✅  aprendeu: assunto favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'lembrete':
        ...
        console.log(`✅  anotou: "${valor}" sobre ${grupoUserId}`);
        break;
      ...
      case 'momento_especial':
        ...
        console.log(`✅  guardou memória especial: "${valor}" com ${grupoUserId}`);
        break;
        
      case 'nome':
        // Atualizar o nome do usuário
        userContextDB.updateUserInfo(grupoUserId, valor, null);
        console.log(`✅  aprendeu o nome: ${grupoUserId} se chama "${valor}"`);
        break;
      ...
      case 'nickname':
        ...
        console.log(`✅  aprendeu apelido: ${grupoUserId} gosta de ser chamado de "${valor}"`);
        break;
        
      case 'idade':
        userContextDB.updatePersonalInfo(grupoUserId, 'idade', valor);
        console.log(`✅  aprendeu: ${grupoUserId} tem ${valor} anos`);
        break;
      ...
      case 'lugar':
        ...
        console.log(`✅  aprendeu: ${grupoUserId} mora em "${valor}"`);
        break;
      ...
      case 'ocupação':
        ...
        console.log(`✅  aprendeu: ${grupoUserId} trabalha como "${valor}"`);
        break;
      ...
      case 'status':
        ...
        console.log(`✅  aprendeu: status de relacionamento de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'parentes':
        ...
        if (!contextoAtual.informacoes_pessoais.familia.includes(valor)) {
          ...
          console.log(`✅  aprendeu sobre família de ${grupoUserId}: "${valor}"`);
        }
        break;
      ...
      case 'informação_pessoal':
        ...
        if (campo && camposValidos.includes(campo)) {
          ...
          console.log(`✅  aprendeu info pessoal de ${grupoUserId}: ${campo} = "${valor}"`);
        } else {
          // Se não souber o campo, adicionar como nota importante
          userContextDB.addImportantNote(grupoUserId, valor);
          console.log(`✅  anotou info pessoal: "${valor}" sobre ${grupoUserId}`);
        }
        break;
      ...
      case 'estado_emocional':
        ...
        userContextDB.saveDatabase();
        console.log(`✅  percebeu o humor de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'jeito':
        ...
        userContextDB.saveDatabase();
        console.log(`✅  identificou estilo de conversa de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'aspiração':
        ...
        console.log(`✅  anotou sonho/objetivo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'receio':
        ...
        console.log(`✅  anotou medo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'costume':
        ...
        console.log(`✅  anotou rotina de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'animal_de_estimação':
        ...
        console.log(`✅  anotou sobre pet de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'artista':
        ...
        console.log(`✅  anotou gosto musical de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'anime':
        ...
        console.log(`✅  anotou filme/série favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'games':
        ...
        console.log(`✅  anotou jogo favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'culinária':
        ...
        console.log(`✅  anotou comida favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'drink':
        ...
        console.log(`✅  anotou bebida favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'cores':
        ...
        console.log(`✅  anotou cor favorita de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'clube':
        ...
        console.log(`✅  anotou sobre esporte de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'leitura':
        ...
        console.log(`✅  anotou livro favorito de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'destino':
        ...
        console.log(`✅  anotou sobre viagem de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'formação':
        ...
        console.log(`✅  anotou sobre estudos de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'língua':
        ...
        console.log(`✅  anotou idioma de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'dom':
        ...
        console.log(`✅  anotou talento de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'preocupação':
        ...
        console.log(`✅  anotou preocupação de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'sucesso':
        ...
        console.log(`✅  celebrou conquista de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'birthday':
        ...
        console.log(`✅  anotou aniversário de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'zodíaco':
        ...
        console.log(`✅  anotou signo de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'característica':
        ...
        console.log(`✅  anotou sobre personalidade de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'alergia':
        ...
        console.log(`✅  anotou sobre saúde de ${grupoUserId}: "${valor}"`);
        break;
      ...
      case 'futuro':
        ...
        console.log(`✅  anotou planos de ${grupoUserId}: "${valor}"`);
        break;
      ...
      default:
        ...
        if (tipoLower.includes('gost') || tipoLower.includes('adora') || tipoLower.includes('ama') || 
          ...
          console.log(`📝  categorizou como GOSTO: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é algo que não gosta
          ...
          console.log(`📝  categorizou como NÃO GOSTA: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é uma atividade/hobby
          ...
          console.log(`📝  categorizou como HOBBY: "${tipo}: ${valor}"`);
        }
        // Tentar identificar se é informação pessoal
          ...
          userContextDB.data[grupoUserId] = userCtx;
          userContextDB.saveDatabase();
          console.log(`📝  salvou INFO PERSONALIZADA: "${tipo}: ${valor}"`);
        }
        // Se não conseguir categorizar, salvar como nota importante com o tipo original
          ...
          console.log(`📝  anotou (tipo personalizado): "${tipo}: ${valor}" sobre ${grupoUserId}`);
        }
    }
  } catch (error) {
...
function getGreeting(isNightTime, now) {
...
function getMoodResponse(mood, userName) {
  const moodResponses = {
    happy: [
...
function getTeasingResponse(userName) {
  const teasings = [
...
function getMemoryReminder(userName, topic) {
...
function getContextualResponse(userName, context) {
...
function getFlirtyResponse(userName) {
...
function getPlayfulResponse(userName) {
...
function getDeepResponse(userName) {
  const deepResponses = [
...
function getMotivationalResponse(userName) {
...
function getRomanticResponse(userName) {
...
function getProtectiveResponse(userName) {
...
function getSupportiveResponse(userName) {
...
function getFunnyResponse(userName) {
...
function getCaringResponse(userName) {
...
function enhanceResponse(response, greeting, isNightTime) {
...
function getErrorResponse(error, nazu, ownerNumber) {
...
function getFarewell(isNightTime) {
  if (isNightTime) {
